...
**Spark Core APIs**
Spark core consists of structured API and unstructured API. Structured API consists of Data Frames and Data Sets. Unstructured APIs consists of RDDs[^4]. These core APIs (available as Scala, Java, Python and R) facilitate the execution of high-level operators with RDD.  
